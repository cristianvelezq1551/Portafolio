            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      MyTile(Icons.settings_outlined, 'Ajustes', () {
                        HapticFeedback.lightImpact();
                        Fluttertoast.showToast(
                          msg: 'Button pressed',
                        );
                      }),
                      MyTile(Icons.info_outline_rounded, 'Acerca de', () {
                        HapticFeedback.lightImpact();
                        Fluttertoast.showToast(
                          msg: 'Button pressed',
                        );
                      }),
                      MyTile(Icons.feedback_outlined, 'Retroalimentación', () {
                        HapticFeedback.lightImpact();
                        Fluttertoast.showToast(
                          msg: 'Button pressed',
                        );
                      }),
                      MyTile(Icons.find_in_page_outlined,
